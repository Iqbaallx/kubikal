      ...
      <div class="container mx-auto text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div
            ...
            <img src="" alt="Live Acoustic Night"
          ...
          <div
            class="event-card bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-md transform transition duration-300 hover:-translate-y-2">
            <img src="" alt="Latte Art Workshop"
              class="rounded-md mb-4 w-full h-40 object-cover bg-gray-300 dark:bg-gray-600">
          ...
          <div
            class="event-card bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-md transform transition duration-300 hover:-translate-y-2">
            <img src="" alt="Holiday Specials Tasting"
              class="rounded-md mb-4 w-full h-40 object-cover bg-gray-300 dark:bg-gray-600">
    ...
    <section class="py-16 px-4 md:px-8 lg:px-16 bg-gray-200 dark:bg-gray-700">
      <div class="container mx-auto text-center">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          <div
            @click="openMenuModal({ name: 'Cappuccino', price: 'Rp 25.000', description: 'Kopi susu klasik dengan foam lembut dan taburan cokelat di atasnya. Menggunakan espresso berkualitas tinggi dipadu dengan susu segar.', image: '' })"
            ...
            <img src="" alt="Cappuccino" class="w-full h-40 object-cover bg-gray-300 dark:bg-gray-600">
            <div class="p-4">
          ...
          <div
            @click="openMenuModal({ name: 'Latte', price: 'Rp 25.000', description: 'Perpaduan espresso dan susu steamed dengan sedikit lapisan foam di atasnya.', image: '' })"
            class="menu-item bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transform transition duration-300 hover:-translate-y-2 cursor-pointer">
            <img src="" alt="Latte" class="w-full h-40 object-cover bg-gray-300 dark:bg-gray-600">
            <div class="p-4">
          ...
          <div
            @click="openMenuModal({ name: 'Espresso', price: 'Rp 20.000', description: 'Ekstraksi kopi murni dengan crema tebal, dasar dari banyak minuman kopi.', image: '' })"
            class="menu-item bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transform transition duration-300 hover:-translate-y-2 cursor-pointer">
            <img src="" alt="Espresso" class="w-full h-40 object-cover bg-gray-300 dark:bg-gray-600">
            <div class="p-4">
          ...
          <div
            @click="openMenuModal({ name: 'Cold Brew', price: 'Rp 30.000', description: 'Kopi yang diseduh dengan air dingin selama berjam-jam, menghasilkan rasa yang halus dan rendah asam.', image: '' })"
            class="menu-item bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transform transition duration-300 hover:-translate-y-2 cursor-pointer">
            <img src="" alt="Cold Brew" class="w-full h-40 object-cover bg-gray-300 dark:bg-gray-600">
            <div class="p-4">
...
import { ref } from 'vue';
import MenuDetailModal from '@/Components/MenuDetailModal.vue'; // Pastikan path ini benar
